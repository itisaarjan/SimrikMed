...
function PhysicalExam() {
  return (
    ...
    header={<h1></h1>}
    content={<>
  <h1 className='text-[0.8rem] sm:text-2xl'>We will place the order for diagnostic imaging, such as X-ray, MRI, CT scan, or ultrasound, at your nearest imaging facility.</h1>

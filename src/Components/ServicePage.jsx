    ...
    <div className='flex flex-col items-center justify-center w-[80%] mx-auto'> {/* Centered horizontally */}
      ...
      <div className='flex flex-col items-center justify-center'>
          ...
          <div>
              ...
              {props.price && (
                <h1 className='text-1xl mt-8 text-[red] text-center'> 
                  <div className="flex justify-center items-center min-h-[200px] bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-xl shadow-xl p-8 m-4">
